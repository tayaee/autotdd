# ping-minimaxcli.ps1 — diagnostic: confirms minimaxcli actually responds.
...
# exercised ping-minimaxcli.sh until run for real on a Windows/PowerShell host.

$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$WrapperName = "minimaxcli"
