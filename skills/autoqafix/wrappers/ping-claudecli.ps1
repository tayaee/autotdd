# ping-claudecli.ps1 — diagnostic: confirms claudecli actually responds.
...
# exercised ping-claudecli.sh until run for real on a Windows/PowerShell host.

$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$WrapperName = "claudecli"
