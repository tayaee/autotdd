# ping-deepseekcli.ps1 — diagnostic: confirms deepseekcli actually responds.
...
# exercised ping-deepseekcli.sh until run for real on a Windows/PowerShell host.

$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$WrapperName = "deepseekcli"
