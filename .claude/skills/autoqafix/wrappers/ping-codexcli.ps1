# ping-codexcli.ps1 — diagnostic: confirms codexcli actually responds.
...
# exercised ping-codexcli.sh until run for real on a Windows/PowerShell host.

$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$WrapperName = "codexcli"
